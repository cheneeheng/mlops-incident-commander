# 09 — Routine operations

Day-to-day procedures. Install is in [07](07-ops-install.md); failures are in [11](11-ops-runbook.md).
...
The dashboard button is the normal path ([05](05-user-evals-and-costs.md)); this is the scriptable
