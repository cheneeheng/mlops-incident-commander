# 01 — What the system does, and a tour of the dashboard
...
- A running control plane and dashboard. Your operator sets these up (see
  [07 — Install and first run](07-ops-install.md)); the dashboard is normally at
  <http://localhost:5173>.
...
**Next:** [02 — Run a fault drill](02-user-run-a-fault-drill.md).
