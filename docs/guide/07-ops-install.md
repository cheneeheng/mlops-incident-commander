...
2. Create the environment file and fill in the API key.
   ...
   [08 — Configuration](08-ops-configuration.md). `.env` is never committed.
...
**If it fails:** see [11 — Incident runbook](11-ops-runbook.md). The most common first-run failures
...
**Next:** [08 — Configuration](08-ops-configuration.md).
