...
startup. See [11 — Incident runbook](11-ops-runbook.md).
...
5. Restart serving, the control plane, and the dashboard ([09 — Routine
   operations](09-ops-routine-operations.md)).
