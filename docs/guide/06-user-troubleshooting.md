# 06 — Troubleshooting (dashboard)

Symptoms you can see and act on from the browser. Anything that needs a shell is in
[11 — Incident runbook](11-ops-runbook.md); hand those items to your operator.

| Symptom | Likely cause | What to do |
|---------|--------------|------------|
| A **sample data** badge sits in the header | The dashboard is running against hardcoded sample data, not a live backend | Nothing on screen is real. Ask your operator to unset `VITE_USE_STUBS` — see [08 — Configuration](08-ops-configuration.md) |
